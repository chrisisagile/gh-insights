...
export class GitHubAnalystAgent {
  ...
  private buildGraph() {
    const workflow = new StateGraph(GraphAnnotation)
      .addNode('generate_overview', this.generateOverview.bind(this))
      .addNode('select_prs', this.selectPRs.bind(this))
      .addNode('analyze_prs', this.analyzePRs.bind(this))
      .addNode('generate_report', this.generateReport.bind(this))
      .addNode('generate_coaching', this.generateCoaching.bind(this))
  ...
  private async generateOverview(state: GraphState): Promise<Partial<GraphState>> {
    try {
  ...
  private async selectPRs(state: GraphState): Promise<Partial<GraphState>> {
    try {
  ...
  private async analyzePRs(state: GraphState): Promise<Partial<GraphState>> {
    try {
  ...
  private async generateCoaching(state: GraphState): Promise<Partial<GraphState>> {
    try {
  ...
  private async generateReport(state: GraphState): Promise<Partial<GraphState>> {
    try {
...
`;
  ...
  private async saveResults(state: GraphState): Promise<Partial<GraphState>> {
    try {
